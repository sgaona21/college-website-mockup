...
function calculateRate() {
    // this function uses a regular expression (generated by chatgpt) to evaluate the input. if the zip code is valid, the function will then check to see if the zip code begins with an 8. if it begins with an 8 then a message is displayed, if not a separate message is displayed.
    let zipRegEx = /^\d{5}$/;
